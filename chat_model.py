...
class ChatModel:
    ...
    def training_data(self, w, words, documents, classes, lemmatizer):
        ...
        for doc in documents:
            ...
            training.append([bag, output_row])  # Append the bag of words and output row as a pair

        # shuffle our features and turn into np.array
        random.shuffle(training)
        # Separate bag of words and output rows
    ...
    def training(self,train_x, train_y):
        ...
        sgd = SGD(learning_rate=0.01, decay=1e-6, momentum=0.9, nesterov=True)  # Change lr to learning_rate
